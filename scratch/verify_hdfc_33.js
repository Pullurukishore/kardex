...
console.log("Length:", row1.length);
const instDateIdx = row1.indexOf("Inst. Date");
console.log("Inst. Date Index:", instDateIdx);
console.log("Commas after Inst. Date:", row1.length - 1 - instDateIdx);
