...
const COOKIE_OPTIONS = {
  ...
  secure: process.env.NODE_ENV === 'production' && typeof window !== 'undefined' && !window.location.hostname.includes('172.28.91.10') && !window.location.hostname.includes('10.91.1.12') && window.location.hostname !== 'localhost'
};
