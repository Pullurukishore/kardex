  ...
  const validateStep = (step: number): { valid: boolean; message?: string } => {
    ...
    if (step === 2) {
      ...
      if (formData.currency === 'INR' && !isValidIFSC(formData.ifscCode)) {
        return { valid: false, message: 'Invalid IFSC Code format. Must be 11 characters (e.g. SBIN0001234)' };
      }
              ...
              <div className="flex items-center gap-3">
                {steps.map((step) => (
                  <div key={step.id} className="flex flex-col items-center gap-1.5">
                    <div
                      className={`w-8 h-8 md:w-10 md:h-10 rounded-xl flex items-center justify-center transition-all duration-300 ${currentStep === step.id ? 'bg-[#CE9F6B] text-white shadow-lg shadow-[#CE9F6B]/30' :
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <div className="space-y-2.5">
                  ...
                  <input
                    ...
                    maxLength={10}
                    className={`w-full px-4 py-2.5 rounded-xl text-sm font-bold uppercase tracking-wider transition-all focus:outline-none border-2 bg-[#F8FAFB] text-[#546A7A] ${fieldErrors.bpCode ? 'border-[#E17F70] focus:border-[#E17F70]' : 'border-[#AEBFC3] focus:border-[#CE9F6B]/50'
                      }`}
                    required
                  />
                  {fieldErrors.bpCode && (
                ...
                <div className="md:col-span-1 xl:col-span-1 space-y-2.5">
                  ...
                  <input
                    ...
                    maxLength={100}
                    className={`w-full px-4 py-2.5 rounded-xl text-sm font-medium transition-all focus:outline-none border-2 bg-[#F8FAFB] text-[#546A7A] ${fieldErrors.vendorName ? 'border-[#E17F70] focus:border-[#E17F70]' : 'border-[#AEBFC3] focus:border-[#CE9F6B]/50'
                      }`}
                    required
                  />
                ...
                <div className="space-y-2.5">
                  ...
                  <input
                    ...
                    maxLength={30}
                    className={`w-full px-4 py-2.5 rounded-xl text-sm font-medium transition-all focus:outline-none border-2 bg-[#F8FAFB] text-[#546A7A] ${fieldErrors.nickName ? 'border-[#E17F70] focus:border-[#E17F70]' : 'border-[#AEBFC3] focus:border-[#CE9F6B]/50'
                      }`}
                  />
                ...
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    maxLength={50}
                    className={`w-full px-4 py-2.5 rounded-xl text-sm font-medium transition-all focus:outline-none border-2 bg-[#F8FAFB] text-[#546A7A] ${fieldErrors.emailId ? 'border-[#E17F70] focus:border-[#E17F70]' : 'border-[#AEBFC3] focus:border-[#CE9F6B]/50'
                      }`}
                  />
                  {fieldErrors.emailId && (
                    <p className="text-[11px] font-medium text-[#E17F70] flex items-center gap-1 mt-1">
                  ...
                  <div className="mt-6 space-y-3 animate-in fade-in slide-in-from-top-4 duration-500">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        maxLength={19}
                        className={`w-full pl-[88px] pr-4 py-3 rounded-xl font-mono font-bold text-base tracking-widest transition-all focus:outline-none border-2 bg-white text-[#546A7A] ${fieldErrors.udyamRegNum ? 'border-[#E17F70]' : 'border-[#CE9F6B]'
                          }`}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-3">
                          ...
                          <input
                            ...
                            maxLength={11}
                            className={`w-full px-4 py-3 rounded-xl font-mono font-black text-base tracking-widest uppercase transition-all focus:outline-none border-2 ${fieldErrors.ifscCode ? 'bg-[#E17F70]/20 border-[#E17F70] text-[#EEC1BF]' : 'bg-white/10 border-white/20 text-[#CE9F6B] focus:border-[#CE9F6B]/50'
                              }`}
                            required
                          />
                    ...
                    {[formData.accountCategory].map((typeId: string) => {
                      ...
                      return (
                        <div key={typeId} className="relative">
                          <div
                            className={`p-1 rounded-[2rem] transition-all bg-gradient-to-r ${fileDetail ? 'from-[#82A094] to-[#4F6A64]' : 'from-[#AEBFC3]/50 to-[#AEBFC3]/20'
                              }`}
                          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-3">
                {[1, 2, 3].map(step => (
                  <div
                    key={step}
                    className={`h-2.5 rounded-full transition-all duration-500 ${currentStep === step ? 'w-8 bg-[#6F8A9D]' : 'w-2.5 bg-[#AEBFC3]'
                ...
                {currentStep < 3 ? (
                  ...
                  <div className="relative group/submit w-full md:w-auto">
                    <Button
                      ...
                      className={`w-full md:w-auto px-10 h-12 rounded-xl font-black text-white shadow-xl transition-all ${success
