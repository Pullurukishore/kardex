...
export default function OfferStats({ stats, createPath = '/expert/offers/new' }: OfferStatsProps) {
      ...
      <div className="relative z-10 flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          ...
          <Button 
            ...
            className="bg-white text-[#9E3B47] hover:bg-white/90 hover:scale-[1.02] active:scale-[0.98] shadow-lg transition-all w-full sm:w-auto font-bold h-9 sm:h-10 text-xs sm:text-sm px-4"
          >
