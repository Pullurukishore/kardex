...
interface SparePartsListPageProps {
  readOnly?: boolean;
}

export default function SparePartsListPage({ readOnly = false }: SparePartsListPageProps) {
  ...
  return (
    <div className="space-y-8 p-6 bg-gradient-to-br from-[#AEBFC3]/10 via-blue-50/30 to-[#96AEC2]/10 min-h-screen">
      {/* Header */}
      ...
      {loading ? (
        ...
        <SparePartsTable 
          ...
          handleEditPart={(p) => { setSelectedPart(p); setShowFormModal(true); }}
